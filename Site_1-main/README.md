...
| Member        | Stijn De Beuckeleer | r0939822@student.thomasmore.be | SDBeu           |
| Member        | ....                | ....                           | ....            |

[//]: # (## URL: [https://myDomain.be]&#40;https://myDomain.be&#41;)

## URL: [https://huiskamer.laravelbakery.be](https://huiskamer.laravelbakery.be)
## Credentials:
| Role  | Email                | Password  |
|:------|:---------------------|:----------|
| Admin | john.doe@example.com | admin1234 |
| User  | s.vangeel@mail.com   | password  |
